...
|                               | Implement code to update values stored in a two-dimensional array and know its runtime characteristics                                                                                     | Apply                |
...
|                               | Remember that multiple sorting algorithms exist, and be familiar with the most common ones—such as bubble sort, selection sort, and merge sort—along with their typical time complexities. | Remember             |
